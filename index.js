...
GitHubCalendar(".calendar", "kumarroshan123", { responsive: true }); // Display GitHub calendar
// *=============================== resume open in new tab ==================================
    ...
    function NewTab() {
      window.open(
        "https://drive.google.com/file/d/1i26Le8isXzb3HgyaotX-cvD2K7PhMzYm/view?usp=sharing",
        "_blank"
      );
    }
...
const typed = new Typed('.multiple-text', {
  strings: ['Algorithm Developer', 'Python Developer'],
  typeSpeed: 100,
  backSpeed: 100,
  backdelay: 1000,
  loop: true
